...
ULIS_DEFINE_GENERIC_COMMAND_SCHEDULER_FORWARD_SIMPLE( ScheduleValueNoiseMT_MEM_Generic, FSimpleBufferJobArgs, FNoiseCommandArgs, &InvokeValueNoiseMT_MEM_Generic< T > )
ULIS_NAMESPACE_END
