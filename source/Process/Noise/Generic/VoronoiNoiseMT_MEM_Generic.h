...
ULIS_DEFINE_GENERIC_COMMAND_SCHEDULER_FORWARD_SIMPLE( ScheduleVoronoiNoiseMT_MEM_Generic, FSimpleBufferJobArgs, FNoiseCommandArgs, &InvokeVoronoiNoiseMT_MEM_Generic< T > )
ULIS_NAMESPACE_END
