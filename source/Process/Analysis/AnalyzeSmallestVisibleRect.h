...
/////////////////////////////////////////////////////
// Dispatch / Schedule
ULIS_DECLARE_COMMAND_SCHEDULER( ScheduleAnalyzeSmallestVisibleRectXPassMT_MEM );
ULIS_DECLARE_COMMAND_SCHEDULER( ScheduleAnalyzeSmallestVisibleRectYPassMT_MEM );
...
ULIS_DEFINE_DISPATCHER_GENERIC_GROUP_MONO(
    ...
    , &ScheduleAnalyzeSmallestVisibleRectXPassMT_MEM
)
ULIS_DEFINE_DISPATCHER_GENERIC_GROUP_MONO(
      FDispatchedAnalyzeSmallestVisibleRectYPassInvocationSchedulerSelector
    , &ScheduleAnalyzeSmallestVisibleRectYPassMT_MEM
)
