...
*   ULIS
*__________________
* @file         ResizeMT_Bicubic_SSE_RGBA8.cpp
...
void
InvokeResizeMT_Bicubic_SSE_RGBA8( uint8* iDst, int32 iLine, std::shared_ptr< const FResizeCommandArgs > iInfo, const Vec4i iIDT ) {
...
void
ResizeMT_Bicubic_SSE_RGBA8( std::shared_ptr< const FResizeCommandArgs > iInfo ) {
    const FResizeCommandArgs&  info        = *iInfo;
