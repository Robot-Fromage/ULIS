...
*   ULIS
*__________________
* @file         TransformAffineTiledMT_Bilinear_SSE_RGBA8.h
...
void
InvokeTransformAffineTiledMT_Bilinear_SSE_RGBA8( uint8* iDst, int32 iLine, std::shared_ptr< const FTransformArgs > iInfo, const Vec4i iIDT );
