...
*   ULIS
*__________________
* @file         GradientLinearMT_MEM_Generic.h
...
template< typename T >
void
InvokeGradientLinearMT_MEM_Generic(
...
ULIS_DEFINE_GENERIC_COMMAND_SCHEDULER_FORWARD_SIMPLE( ScheduleGradientLinearMT_MEM_Generic, FSimpleBufferJobArgs, FGradientCommandArgs, &InvokeGradientLinearMT_MEM_Generic< T > )
ULIS_NAMESPACE_END
