...
*   ULIS
*__________________
* @file         RasterCircleBresenham.cpp
* @author       Thomas Schmitt
* @brief        This file provides the implementation of non template Circle Bresenham functions for the raster API
* @copyright    Copyright 2018-2021 Praxinos, Inc. All Rights Reserved.
* @license      Please refer to LICENSE.md
*/

#include "RasterCircleBresenham.h"
