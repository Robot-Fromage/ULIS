                                    ...
                                    , const FRectI&            iClippingRect )
{
    ...
    if(drawRectOctant1 == 1)
    {
        ...
        while(y >= x)
        {
            ...
            iBlock.SetPixel(round(iCenter.x + x),round(iCenter.y - y),val); // 0° to 45°

            val.SetAlphaT<T>(T(maxAlpha * alphaTop));

            iBlock.SetPixel(round(iCenter.x + x),round(iCenter.y - y - 1),val); // 0° to 45°
    ...
    if(drawRectOctant2 == 1)
    {
        ...
        while(y >= x)
        {
            ...
            iBlock.SetPixel(round(iCenter.x + y),round(iCenter.y - x),val); // 90° to 45°

            val.SetAlphaT<T>(T(maxAlpha * alphaTop));

            iBlock.SetPixel(round(iCenter.x + y + 1),round(iCenter.y - x),val); // 90° to 45°
    ...
    if(drawRectOctant3 == 1)
    {
        ...
        while(y >= x)
        {
            ...
            iBlock.SetPixel(round(iCenter.x + y),round(iCenter.y + x),val); // 90° to 135°

            val.SetAlphaT<T>(T(maxAlpha * alphaTop));

            iBlock.SetPixel(round(iCenter.x + y + 1),round(iCenter.y + x),val); // 90° to 135°
    ...
    if(drawRectOctant4 == 1)
    {
        ...
        while(y >= x)
        {
            ...
            iBlock.SetPixel(round(iCenter.x + x),round(iCenter.y + y),val); // 180° to 135°

            val.SetAlphaT<T>(T(maxAlpha * alphaTop));

            iBlock.SetPixel(round(iCenter.x + x),round(iCenter.y + y + 1),val); // 180° to 135°
    ...
    if(drawRectOctant5 == 1)
    {
        ...
        while(y >= x)
        {
            ...
            iBlock.SetPixel(round(iCenter.x - x),round(iCenter.y + y),val); // 180° to 225°

            val.SetAlphaT<T>(T(maxAlpha * alphaTop));

            iBlock.SetPixel(round(iCenter.x - x),round(iCenter.y + y + 1),val); // 180° to 225°
    ...
    if(drawRectOctant6 == 1)
    {
        ...
        while(y >= x)
        {
            ...
            iBlock.SetPixel(round(iCenter.x - y),round(iCenter.y + x),val); // 270° to 225°

            val.SetAlphaT<T>(T(maxAlpha * alphaTop));

            iBlock.SetPixel(round(iCenter.x - y - 1),round(iCenter.y + x),val); // 270° to 225°
    ...
    if(drawRectOctant7 == 1)
    {
        ...
        while(y >= x)
        {
            ...
            iBlock.SetPixel(round(iCenter.x - y),round(iCenter.y - x),val); // 270° to 315°

            val.SetAlphaT<T>(T(maxAlpha * alphaTop));

            iBlock.SetPixel(round(iCenter.x - y - 1),round(iCenter.y - x),val); // 270° to 315°
    ...
    if(drawRectOctant8 == 1)
    {
        ...
        while(y >= x)
        {
            ...
            iBlock.SetPixel(round(iCenter.x - x),round(iCenter.y - y),val); // 0° to 315°

            val.SetAlphaT<T>(T(maxAlpha * alphaTop));

            iBlock.SetPixel(round(iCenter.x - x),round(iCenter.y - y - 1),val); // 0° to 315°
