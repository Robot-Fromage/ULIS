...
//Write
#define ULIS_W_HW_AMD( i )          ( ( uint64( i ) & 1 ) << 0    )
#define ULIS_W_HW_INTEL( i )        ( ( uint64( i ) & 1 ) << 1    )
#define ULIS_W_OS_X64( i )          ( ( uint64( i ) & 1 ) << 2    )
#define ULIS_W_OS_AVX( i )          ( ( uint64( i ) & 1 ) << 3    )
#define ULIS_W_OS_AVX512( i )       ( ( uint64( i ) & 1 ) << 4    )
#define ULIS_W_HW_X64( i )          ( ( uint64( i ) & 1 ) << 5    )
#define ULIS_W_HW_MMX( i )          ( ( uint64( i ) & 1 ) << 6    )
#define ULIS_W_HW_ABM( i )          ( ( uint64( i ) & 1 ) << 7    )
#define ULIS_W_HW_RDRAND( i )       ( ( uint64( i ) & 1 ) << 8    )
#define ULIS_W_HW_BMI1( i )         ( ( uint64( i ) & 1 ) << 9    )
#define ULIS_W_HW_BMI2( i )         ( ( uint64( i ) & 1 ) << 10   )
#define ULIS_W_HW_ADX( i )          ( ( uint64( i ) & 1 ) << 11   )
#define ULIS_W_HW_PREFETCHWT1( i )  ( ( uint64( i ) & 1 ) << 12   )
#define ULIS_W_HW_MPX( i )          ( ( uint64( i ) & 1 ) << 13   )
#define ULIS_W_HW_SSE( i )          ( ( uint64( i ) & 1 ) << 14   )
#define ULIS_W_HW_SSE2( i )         ( ( uint64( i ) & 1 ) << 15   )
#define ULIS_W_HW_SSE3( i )         ( ( uint64( i ) & 1 ) << 16   )
#define ULIS_W_HW_SSSE3( i )        ( ( uint64( i ) & 1 ) << 17   )
#define ULIS_W_HW_SSE41( i )        ( ( uint64( i ) & 1 ) << 18   )
#define ULIS_W_HW_SSE42( i )        ( ( uint64( i ) & 1 ) << 19   )
#define ULIS_W_HW_SSE4A( i )        ( ( uint64( i ) & 1 ) << 20   )
#define ULIS_W_HW_AES( i )          ( ( uint64( i ) & 1 ) << 21   )
#define ULIS_W_HW_SHA( i )          ( ( uint64( i ) & 1 ) << 22   )
#define ULIS_W_HW_AVX( i )          ( ( uint64( i ) & 1 ) << 23   )
#define ULIS_W_HW_XOP( i )          ( ( uint64( i ) & 1 ) << 24   )
#define ULIS_W_HW_FMA3( i )         ( ( uint64( i ) & 1 ) << 25   )
#define ULIS_W_HW_FMA4( i )         ( ( uint64( i ) & 1 ) << 26   )
#define ULIS_W_HW_AVX2( i )         ( ( uint64( i ) & 1 ) << 27   )
#define ULIS_W_HW_AVX512_F( i )     ( ( uint64( i ) & 1 ) << 28   )
#define ULIS_W_HW_AVX512_PF( i )    ( ( uint64( i ) & 1 ) << 29   )
#define ULIS_W_HW_AVX512_ER( i )    ( ( uint64( i ) & 1 ) << 30   )
#define ULIS_W_HW_AVX512_CD( i )    ( ( uint64( i ) & 1 ) << 31   )
#define ULIS_W_HW_AVX512_VL( i )    ( ( uint64( i ) & 1 ) << 32   )
#define ULIS_W_HW_AVX512_BW( i )    ( ( uint64( i ) & 1 ) << 33   )
#define ULIS_W_HW_AVX512_DQ( i )    ( ( uint64( i ) & 1 ) << 34   )
#define ULIS_W_HW_AVX512_IFMA( i )  ( ( uint64( i ) & 1 ) << 35   )
#define ULIS_W_HW_AVX512_VBMI( i )  ( ( uint64( i ) & 1 ) << 36   )
// Read
