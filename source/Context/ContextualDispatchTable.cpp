...
FContext::FContextualDispatchTable::FContextualDispatchTable( const FHardwareMetrics& iHardwareMetrics, eFormat iFormat, ePerformanceIntent iPerfIntent )
        ...
        , mScheduleDrawCircle(                      TDispatcher< FDispatchedDrawCircleInvocationSchedulerSelector                       >::Query( iHardwareMetrics, iFormat, iPerfIntent ) )
        , mScheduleDrawCircleAA(                    TDispatcher< FDispatchedDrawCircleAAInvocationSchedulerSelector                     >::Query( iHardwareMetrics, iFormat, iPerfIntent ) )
        , mScheduleDrawCircleSP(                    TDispatcher< FDispatchedDrawCircleSPInvocationSchedulerSelector                     >::Query( iHardwareMetrics, iFormat, iPerfIntent ) )
        , mScheduleDrawArc(                         TDispatcher< FDispatchedDrawArcInvocationSchedulerSelector                          >::Query( iHardwareMetrics, iFormat, iPerfIntent ) )
        , mScheduleDrawArcAA(                       TDispatcher< FDispatchedDrawArcAAInvocationSchedulerSelector                        >::Query( iHardwareMetrics, iFormat, iPerfIntent ) )
        , mScheduleDrawArcSP(                       TDispatcher< FDispatchedDrawArcSPInvocationSchedulerSelector                        >::Query( iHardwareMetrics, iFormat, iPerfIntent ) )
