...
{
    BuildBlendJobs_Separable< &InvokeBlendMTProcessScanline_Separable_SSE_RGBA8_Subpixel >( iCommand, iPolicy );
}
...
{
    BuildBlendJobs_Separable< &InvokeBlendMTProcessScanline_Separable_SSE_RGBA8 >( iCommand, iPolicy );
}
