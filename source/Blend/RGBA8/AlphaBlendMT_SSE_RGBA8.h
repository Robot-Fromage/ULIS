...
ULIS_DECLARE_COMMAND_SCHEDULER( ScheduleAlphaBlendMT_Separable_SSE_RGBA8_Subpixel );
ULIS_DECLARE_COMMAND_SCHEDULER( ScheduleAlphaBlendMT_Separable_SSE_RGBA8 );
