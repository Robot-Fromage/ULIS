...
{
    BuildBlendJobs< &InvokeAlphaBlendMTProcessScanline_Separable_AVX_RGBA8_Subpixel >( iCommand, iPolicy );
}
...
{
    BuildBlendJobs< &InvokeAlphaBlendMTProcessScanline_Separable_AVX_RGBA8 >( iCommand, iPolicy );
}
