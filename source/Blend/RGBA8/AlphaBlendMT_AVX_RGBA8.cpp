...
{
    BuildBlendJobs_Separable< &InvokeAlphaBlendMTProcessScanline_Separable_AVX_RGBA8_Subpixel >( iCommand, iPolicy );
}
...
{
    BuildBlendJobs_Separable< &InvokeAlphaBlendMTProcessScanline_Separable_AVX_RGBA8 >( iCommand, iPolicy );
}
