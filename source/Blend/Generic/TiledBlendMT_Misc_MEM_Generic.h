...
template< typename T >
void
InvokeTiledBlendMTProcessScanline_Misc_MEM_Generic( const uint8* iSrc, uint8* iBdp, int32 iLine, const FBlendArgs* iArgs ) {
...
template< typename T >
void
ScheduleTiledBlendMT_Misc_MEM_Generic( const FBlendArgs* iArgs ) {
    const FBlendArgs&   info        = *iInfo;
