...
{
    BuildBlendJobs_Separable_MEM_Generic< &InvokeBlendMTProcessScanline_Separable_MEM_Generic_Subpixel< T > >( iCommand, iPolicy );
}
...
{
    BuildBlendJobs_Separable_MEM_Generic< &InvokeBlendMTProcessScanline_Separable_MEM_Generic< T > >( iCommand, iPolicy );
}
