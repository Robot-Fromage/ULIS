...
* @brief        This file provides the declaration for the ConvertFormat entry point functions.
...
ULIS_API fpConvertFormat QueryDispatchConvertFormatInvocation( eFormat iSrcFormat, eFormat iDstFormat );
