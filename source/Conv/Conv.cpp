...
#define X_DO_01( T, U )   template ULIS_API void ConvertFormatGreyToGrey< T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_02( T, U )   template ULIS_API void ConvertFormatRGBToGrey<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_03( T, U )   template ULIS_API void ConvertFormatHSVToGrey<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_04( T, U )   template ULIS_API void ConvertFormatHSLToGrey<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_05( T, U )   template ULIS_API void ConvertFormatCMYToGrey<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_06( T, U )   template ULIS_API void ConvertFormatCMYKToGrey< T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_07( T, U )   template ULIS_API void ConvertFormatYUVToGrey<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_08( T, U )   template ULIS_API void ConvertFormatLabToGrey<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_09( T, U )   template ULIS_API void ConvertFormatXYZToGrey<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_10( T, U )   template ULIS_API void ConvertFormatYxyToGrey<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_11( T, U )   template ULIS_API void ConvertFormatGreyToRGB<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_12( T, U )   template ULIS_API void ConvertFormatRGBToRGB<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_13( T, U )   template ULIS_API void ConvertFormatHSVToRGB<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_14( T, U )   template ULIS_API void ConvertFormatHSLToRGB<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_15( T, U )   template ULIS_API void ConvertFormatCMYToRGB<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_16( T, U )   template ULIS_API void ConvertFormatCMYKToRGB<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_17( T, U )   template ULIS_API void ConvertFormatYUVToRGB<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_18( T, U )   template ULIS_API void ConvertFormatLabToRGB<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_19( T, U )   template ULIS_API void ConvertFormatXYZToRGB<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_20( T, U )   template ULIS_API void ConvertFormatYxyToRGB<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_21( T, U )   template ULIS_API void ConvertFormatGreyToHSV<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_22( T, U )   template ULIS_API void ConvertFormatRGBToHSV<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_23( T, U )   template ULIS_API void ConvertFormatHSVToHSV<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_24( T, U )   template ULIS_API void ConvertFormatHSLToHSV<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_25( T, U )   template ULIS_API void ConvertFormatCMYToHSV<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_26( T, U )   template ULIS_API void ConvertFormatCMYKToHSV<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_27( T, U )   template ULIS_API void ConvertFormatYUVToHSV<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_28( T, U )   template ULIS_API void ConvertFormatLabToHSV<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_29( T, U )   template ULIS_API void ConvertFormatXYZToHSV<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_30( T, U )   template ULIS_API void ConvertFormatYxyToHSV<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_31( T, U )   template ULIS_API void ConvertFormatGreyToHSL<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_32( T, U )   template ULIS_API void ConvertFormatRGBToHSL<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_33( T, U )   template ULIS_API void ConvertFormatHSVToHSL<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_34( T, U )   template ULIS_API void ConvertFormatHSLToHSL<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_35( T, U )   template ULIS_API void ConvertFormatCMYToHSL<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_36( T, U )   template ULIS_API void ConvertFormatCMYKToHSL<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_37( T, U )   template ULIS_API void ConvertFormatYUVToHSL<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_38( T, U )   template ULIS_API void ConvertFormatLabToHSL<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_39( T, U )   template ULIS_API void ConvertFormatXYZToHSL<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_40( T, U )   template ULIS_API void ConvertFormatYxyToHSL<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_41( T, U )   template ULIS_API void ConvertFormatGreyToCMY<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_42( T, U )   template ULIS_API void ConvertFormatRGBToCMY<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_43( T, U )   template ULIS_API void ConvertFormatHSVToCMY<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_44( T, U )   template ULIS_API void ConvertFormatHSLToCMY<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_45( T, U )   template ULIS_API void ConvertFormatCMYToCMY<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_46( T, U )   template ULIS_API void ConvertFormatCMYKToCMY<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_47( T, U )   template ULIS_API void ConvertFormatYUVToCMY<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_48( T, U )   template ULIS_API void ConvertFormatLabToCMY<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_49( T, U )   template ULIS_API void ConvertFormatXYZToCMY<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_50( T, U )   template ULIS_API void ConvertFormatYxyToCMY<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_51( T, U )   template ULIS_API void ConvertFormatGreyToCMYK< T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_52( T, U )   template ULIS_API void ConvertFormatRGBToCMYK<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_53( T, U )   template ULIS_API void ConvertFormatHSVToCMYK<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_54( T, U )   template ULIS_API void ConvertFormatHSLToCMYK<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_55( T, U )   template ULIS_API void ConvertFormatCMYToCMYK<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_56( T, U )   template ULIS_API void ConvertFormatCMYKToCMYK< T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_57( T, U )   template ULIS_API void ConvertFormatYUVToCMYK<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_58( T, U )   template ULIS_API void ConvertFormatLabToCMYK<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_59( T, U )   template ULIS_API void ConvertFormatXYZToCMYK<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_60( T, U )   template ULIS_API void ConvertFormatYxyToCMYK<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_61( T, U )   template ULIS_API void ConvertFormatGreyToYUV<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_62( T, U )   template ULIS_API void ConvertFormatRGBToYUV<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_63( T, U )   template ULIS_API void ConvertFormatHSVToYUV<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_64( T, U )   template ULIS_API void ConvertFormatHSLToYUV<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_65( T, U )   template ULIS_API void ConvertFormatCMYToYUV<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_66( T, U )   template ULIS_API void ConvertFormatCMYKToYUV<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_67( T, U )   template ULIS_API void ConvertFormatYUVToYUV<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_68( T, U )   template ULIS_API void ConvertFormatLabToYUV<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_69( T, U )   template ULIS_API void ConvertFormatXYZToYUV<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_70( T, U )   template ULIS_API void ConvertFormatYxyToYUV<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_71( T, U )   template ULIS_API void ConvertFormatGreyToLab<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_72( T, U )   template ULIS_API void ConvertFormatRGBToLab<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_73( T, U )   template ULIS_API void ConvertFormatHSVToLab<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_74( T, U )   template ULIS_API void ConvertFormatHSLToLab<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_75( T, U )   template ULIS_API void ConvertFormatCMYToLab<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_76( T, U )   template ULIS_API void ConvertFormatCMYKToLab<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_77( T, U )   template ULIS_API void ConvertFormatYUVToLab<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_78( T, U )   template ULIS_API void ConvertFormatLabToLab<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_79( T, U )   template ULIS_API void ConvertFormatXYZToLab<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_80( T, U )   template ULIS_API void ConvertFormatYxyToLab<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_81( T, U )   template ULIS_API void ConvertFormatGreyToXYZ<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_82( T, U )   template ULIS_API void ConvertFormatRGBToXYZ<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_83( T, U )   template ULIS_API void ConvertFormatHSVToXYZ<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_84( T, U )   template ULIS_API void ConvertFormatHSLToXYZ<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_85( T, U )   template ULIS_API void ConvertFormatCMYToXYZ<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_86( T, U )   template ULIS_API void ConvertFormatCMYKToXYZ<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_87( T, U )   template ULIS_API void ConvertFormatYUVToXYZ<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_88( T, U )   template ULIS_API void ConvertFormatLabToXYZ<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_89( T, U )   template ULIS_API void ConvertFormatXYZToXYZ<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_90( T, U )   template ULIS_API void ConvertFormatYxyToXYZ<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_91( T, U )   template ULIS_API void ConvertFormatGreyToYxy<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_92( T, U )   template ULIS_API void ConvertFormatRGBToYxy<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_93( T, U )   template ULIS_API void ConvertFormatHSVToYxy<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_94( T, U )   template ULIS_API void ConvertFormatHSLToYxy<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_95( T, U )   template ULIS_API void ConvertFormatCMYToYxy<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_96( T, U )   template ULIS_API void ConvertFormatCMYKToYxy<  T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_97( T, U )   template ULIS_API void ConvertFormatYUVToYxy<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_98( T, U )   template ULIS_API void ConvertFormatLabToYxy<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_99( T, U )   template ULIS_API void ConvertFormatXYZToYxy<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
#define X_DO_FF( T, U )   template ULIS_API void ConvertFormatYxyToYxy<   T, U >( const FPixel& iSrc, FPixel& iDst, uint32 iLen );
