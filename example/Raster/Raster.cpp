...
main(int argc,char *argv[]) 
{
    ...
    ctx.Finish();
    {
        ...
        //ctx.DrawCircleBresenhamAA(canvas,FVec2I(950,300),250,FColor::RGBA8(50,0,0,100));
        //ctx.DrawCircleBresenhamAA(canvas,FVec2I(950,950),250,FColor::RGBA8(50,0,0,100));
