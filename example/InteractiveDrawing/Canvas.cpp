    ...
    switch (mRasterOp)
    {
        ...
        case kEllipse:
            ...
            else if (mRasterMode == eRasterMode::kGeneratePoints)
            {
                TArray<FVec2I> points;
                FColor color = FColor::HSVA8(0, 255, 255, 255);
                GenerateEllipsePoints( FVec2I(mPoints[0].x(), mPoints[0].y()), FMath::Abs(mPoints[0].x() - mPoints[1].x()), FMath::Abs(mPoints[0].y() - mPoints[1].y()), points);
                for (int i = 0; i < points.Size(); i++)
                {
                    color.SetHue8(i % 255);
                    mTemp->SetPixelSafe(points[i].x, points[i].y, color);
        ...
        case kRotatedEllipse:
            ...
            else if (mRasterMode == eRasterMode::kGeneratePoints)
            {
                TArray<FVec2I> points;
                FColor color = FColor::HSVA8(0, 255, 255, 255);
                GenerateRotatedEllipsePoints( FVec2I(mPoints[0].x(), mPoints[0].y()), FMath::Abs(mPoints[0].x() - mPoints[1].x()), FMath::Abs(mPoints[0].y() - mPoints[1].y()), mAngle, points);
                for (int i = 0; i < points.Size(); i++)
                {
                    color.SetHue8(i % 255);
                    mTemp->SetPixelSafe(points[i].x, points[i].y, color);
        ...
        case kQuadraticBezier:
            ...
            else if (mRasterMode == eRasterMode::kGeneratePoints)
            {
                TArray<FVec2I> points;
                FColor color = FColor::HSVA8(0, 255, 255, 255);
                GenerateQuadraticBezierPoints( FVec2I(mPoints[0].x(), mPoints[0].y()), FVec2I(mPoints[1].x(), mPoints[1].y()), FVec2I(mPoints[2].x(), mPoints[2].y()), 1, points);
                for (int i = 0; i < points.Size(); i++)
                {
                    color.SetHue8(i % 255);
                    mTemp->SetPixelSafe(points[i].x, points[i].y, color);
