...
PYBIND11_MODULE( pyULIS4, m ) {
    ...
    py::class_< FContext >( m, "FContext" )
        ...
        .def( "DrawArc", ctxCallAdapter< FBlock&, const FVec2I&, const int, const int, const int, const FColor&, const FRectI&, const FSchedulePolicy& >( &FContext::DrawArc )
        ...
        .def( "DrawArcAA", ctxCallAdapter< FBlock&, const FVec2I&, const int, const int, const int, const FColor&, const FRectI&, const FSchedulePolicy& >( &FContext::DrawArcAA )
            , "block"_a, "center"_a, "radius"_a, "startDegree"_a, "endDegree"_a, "color"_a = FColor::Black, "rect"_a = FRectI::Auto, "policy"_a = FSchedulePolicy::MonoChunk, "waitList"_a = py::list(), "event"_a = nullptr )
        .def( "DrawArcSP", ctxCallAdapter< FBlock&, const FVec2F&, const float, const int, const int, const FColor&, const FRectI&, const FSchedulePolicy& >( &FContext::DrawArcSP )
            , "block"_a, "center"_a, "radius"_a, "startDegree"_a, "endDegree"_a, "color"_a = FColor::Black, "rect"_a = FRectI::Auto, "policy"_a = FSchedulePolicy::MonoChunk, "waitList"_a = py::list(), "event"_a = nullptr )
        .def( "DrawCircle", ctxCallAdapter< FBlock&, const FVec2I&, const int, const FColor&, const bool,  const FRectI&, const FSchedulePolicy& >( &FContext::DrawCircle )
        ...
        .def( "DrawCircleAA", ctxCallAdapter< FBlock&, const FVec2I&, const int, const FColor&, const bool,  const FRectI&, const FSchedulePolicy& >( &FContext::DrawCircleAA )
            , "block"_a, "center"_a, "radius"_a, "color"_a = FColor::Black, "filled"_a = false, "rect"_a = FRectI::Auto, "policy"_a = FSchedulePolicy::MonoChunk, "waitList"_a = py::list(), "event"_a = nullptr )
        .def( "DrawCircleSP", ctxCallAdapter< FBlock&, const FVec2F&, const float, const FColor&, const bool,  const FRectI&, const FSchedulePolicy& >( &FContext::DrawCircleSP )
            , "block"_a, "center"_a, "radius"_a, "color"_a = FColor::Black, "filled"_a = false, "rect"_a = FRectI::Auto, "policy"_a = FSchedulePolicy::MonoChunk, "waitList"_a = py::list(), "event"_a = nullptr )
        ...
        .def( "DrawLineSP", ctxCallAdapter< FBlock&, const FVec2F&, const FVec2F&, const FColor&, const FRectI&, const FSchedulePolicy& >( &FContext::DrawLineSP )
            , "block"_a, "p0"_a, "p1"_a, "color"_a = FColor::Black, "rect"_a = FRectI::Auto, "policy"_a = FSchedulePolicy::MonoChunk, "waitList"_a = py::list(), "event"_a = nullptr )
        .def( "DrawPolygon", ctxCallAdapter< FBlock&, const std::vector< FVec2I >&, const FColor&, const bool, const FRectI&, const FSchedulePolicy& >( &FContext::DrawPolygon )
            , "block"_a, "points"_a, "color"_a = FColor::Black, "filled"_a = false, "rect"_a = FRectI::Auto, "policy"_a = FSchedulePolicy::MonoChunk, "waitList"_a = py::list(), "event"_a = nullptr )
        .def( "DrawPolygonAA", ctxCallAdapter< FBlock&, const std::vector< FVec2I >&, const FColor&, const bool, const FRectI&, const FSchedulePolicy& >( &FContext::DrawPolygonAA )
            , "block"_a, "points"_a, "color"_a = FColor::Black, "filled"_a = false, "rect"_a = FRectI::Auto, "policy"_a = FSchedulePolicy::MonoChunk, "waitList"_a = py::list(), "event"_a = nullptr )
        .def( "DrawPolygonSP", ctxCallAdapter< FBlock&, const std::vector< FVec2F >&, const FColor&, const bool, const FRectI&, const FSchedulePolicy& >( &FContext::DrawPolygonSP )
            , "block"_a, "points"_a, "color"_a = FColor::Black, "filled"_a = false, "rect"_a = FRectI::Auto, "policy"_a = FSchedulePolicy::MonoChunk, "waitList"_a = py::list(), "event"_a = nullptr )
        .def( "DrawQuadraticBezier", ctxCallAdapter< FBlock&, const FVec2I&, const FVec2I&, const FVec2I&, const float, const FColor&, const FRectI&, const FSchedulePolicy& >( &FContext::DrawQuadraticBezier )
            , "block"_a, "p0"_a, "p1"_a, "p2"_a, "weight"_a, "color"_a = FColor::Black, "rect"_a = FRectI::Auto, "policy"_a = FSchedulePolicy::MonoChunk, "waitList"_a = py::list(), "event"_a = nullptr )
        .def( "DrawQuadraticBezierAA", ctxCallAdapter< FBlock&, const FVec2I&, const FVec2I&, const FVec2I&, const float, const FColor&, const FRectI&, const FSchedulePolicy& >( &FContext::DrawQuadraticBezierAA )
            , "block"_a, "p0"_a, "p1"_a, "p2"_a, "weight"_a, "color"_a = FColor::Black, "rect"_a = FRectI::Auto, "policy"_a = FSchedulePolicy::MonoChunk, "waitList"_a = py::list(), "event"_a = nullptr )
        .def( "DrawQuadraticBezierSP", ctxCallAdapter< FBlock&, const FVec2F&, const FVec2F&, const FVec2F&, const float, const FColor&, const FRectI&, const FSchedulePolicy& >( &FContext::DrawQuadraticBezierSP )
            , "block"_a, "p0"_a, "p1"_a, "p2"_a, "weight"_a, "color"_a = FColor::Black, "rect"_a = FRectI::Auto, "policy"_a = FSchedulePolicy::MonoChunk, "waitList"_a = py::list(), "event"_a = nullptr )
        .def( "DrawRectangle", ctxCallAdapter< FBlock&, const FVec2I&, const FVec2I&, const FColor&, const bool, const FRectI&, const FSchedulePolicy& >( &FContext::DrawRectangle )
            , "block"_a, "topLeft"_a, "botRight"_a, "color"_a = FColor::Black, "filled"_a = false, "rect"_a = FRectI::Auto, "policy"_a = FSchedulePolicy::MonoChunk, "waitList"_a = py::list(), "event"_a = nullptr )
        .def( "DrawRotatedEllipse", ctxCallAdapter< FBlock&, const FVec2I&, const int, const int, const int, const FColor&, const bool, const FRectI&, const FSchedulePolicy& >( &FContext::DrawRotatedEllipse )
            , "block"_a, "center"_a, "a"_a, "b"_a, "rotationDegree"_a, "color"_a = FColor::Black, "filled"_a = false, "rect"_a = FRectI::Auto, "policy"_a = FSchedulePolicy::MonoChunk, "waitList"_a = py::list(), "event"_a = nullptr )
        .def( "DrawRotatedEllipseAA", ctxCallAdapter< FBlock&, const FVec2I&, const int, const int, const int, const FColor&, const bool, const FRectI&, const FSchedulePolicy& >( &FContext::DrawRotatedEllipseAA )
            , "block"_a, "center"_a, "a"_a, "b"_a, "rotationDegree"_a, "color"_a = FColor::Black, "filled"_a = false, "rect"_a = FRectI::Auto, "policy"_a = FSchedulePolicy::MonoChunk, "waitList"_a = py::list(), "event"_a = nullptr )
        .def( "DrawRotatedEllipseSP", ctxCallAdapter< FBlock&, const FVec2F&, const float, const float, const int, const FColor&, const bool, const FRectI&, const FSchedulePolicy& >( &FContext::DrawRotatedEllipseAA )
            , "block"_a, "center"_a, "a"_a, "b"_a, "rotationDegree"_a, "color"_a = FColor::Black, "filled"_a = false, "rect"_a = FRectI::Auto, "policy"_a = FSchedulePolicy::MonoChunk, "waitList"_a = py::list(), "event"_a = nullptr )
        ...
        .def( "Swap", ctxCallAdapter< FBlock&, ULIS::uint8, ULIS::uint8, const FRectI&, const FSchedulePolicy& >( &FContext::Swap )
            , "block"_a, "c0"_a, "c1"_a, "rect"_a = FRectI::Auto, "policy"_a = FSchedulePolicy::MultiScanlines, "waitList"_a = py::list(), "event"_a = nullptr )
        .def_static( "TextMetrics", &FContext::TextMetrics )
        .def( "TransformAffine", ctxCallAdapter< const FBlock&, FBlock&, const FRectI&, const FMat3F&, eResamplingMethod, eBorderMode, const ISample&, const FSchedulePolicy& >( &FContext::TransformAffine )
            , "src"_a, "dst"_a, "rect"_a = FRectI::Auto, "mat"_a = FMat3F(), "resamplingMethod"_a = eResamplingMethod::Resampling_Bilinear, "borderMode"_a = eBorderMode::Border_Transparent, "borderValue"_a = FColor::Transparent, "policy"_a = FSchedulePolicy::MultiScanlines, "waitList"_a = py::list(), "event"_a = nullptr )
        .def_static( "TransformAffineMetrics", &FContext::TransformAffineMetrics )
        .def( "TransformAffineTiled", ctxCallAdapter< const FBlock&, FBlock&, const FRectI&, const FRectI&, const FMat3F&, eResamplingMethod, eBorderMode, const ISample&, const FSchedulePolicy& >( &FContext::TransformAffineTiled )
            , "src"_a, "dst"_a, "srcRect"_a = FRectI::Auto, "dstRect"_a = FRectI::Auto, "mat"_a = FMat3F(), "resamplingMethod"_a = eResamplingMethod::Resampling_Bilinear, "borderMode"_a = eBorderMode::Border_Transparent, "borderValue"_a = FColor::Transparent, "policy"_a = FSchedulePolicy::MultiScanlines, "waitList"_a = py::list(), "event"_a = nullptr )
        .def( "TransformBezier", ctxCallAdapter< const FBlock&, FBlock&, const TArray< FCubicBezierControlPoint >&, float, ULIS::uint32, const FRectI&, eResamplingMethod, eBorderMode, const ISample&, const FSchedulePolicy& >( &FContext::TransformBezier )
            , "src"_a, "dst"_a, "points"_a, "threshold"_a = 1.f, "plotSize"_a = 1, "rect"_a = FRectI::Auto, "resamplingMethod"_a = eResamplingMethod::Resampling_Bilinear, "borderMode"_a = eBorderMode::Border_Transparent, "borderValue"_a = FColor::Transparent, "policy"_a = FSchedulePolicy::MultiScanlines, "waitList"_a = py::list(), "event"_a = nullptr )
        .def_static( "TransformBezierMetrics", &FContext::TransformBezierMetrics )
        .def( "TransformPerspective", ctxCallAdapter< const FBlock&, FBlock&, const FRectI&, const FMat3F&, eResamplingMethod, eBorderMode, const ISample&, const FSchedulePolicy& >( &FContext::TransformPerspective )
            , "src"_a, "dst"_a, "rect"_a = FRectI::Auto, "mat"_a = FMat3F(), "resamplingMethod"_a = eResamplingMethod::Resampling_Bilinear, "borderMode"_a = eBorderMode::Border_Transparent, "borderValue"_a = FColor::Transparent, "policy"_a = FSchedulePolicy::MultiScanlines, "waitList"_a = py::list(), "event"_a = nullptr )
        .def_static( "TransformPerspectiveMetrics", &FContext::TransformBezierMetrics )
        .def( "Unpremultiply", ctxCallAdapter< FBlock&, const FRectI&, const FSchedulePolicy& >( &FContext::Unpremultiply ) )
        .def( "ValueNoise", ctxCallAdapter< FBlock&, float, int, const FRectI&, const FSchedulePolicy& >( &FContext::ValueNoise )
            , "block"_a, "freq"_a = 1.f, "seed"_a = -1, "rect"_a = FRectI::Auto, "policy"_a = FSchedulePolicy::MultiScanlines, "waitList"_a = py::list(), "event"_a = nullptr )
        .def( "VoronoiNoise", ctxCallAdapter< FBlock&, ULIS::uint32, int, const FRectI&, const FSchedulePolicy& >( &FContext::VoronoiNoise )
            , "block"_a, "count"_a, "seed"_a = -1, "rect"_a = FRectI::Auto, "policy"_a = FSchedulePolicy::MultiScanlines, "waitList"_a = py::list(), "event"_a = nullptr )
        .def( "Wait", &FContext::Wait )
        .def( "WhiteNoise", ctxCallAdapter< FBlock&, int, const FRectI&, const FSchedulePolicy& >( &FContext::WhiteNoise )
            , "block"_a, "seed"_a = -1, "rect"_a = FRectI::Auto, "policy"_a = FSchedulePolicy::MultiScanlines, "waitList"_a = py::list(), "event"_a = nullptr )
        .def( "XAllocateBlockData", ctxCallAdapter< FBlock&, ULIS::uint16, ULIS::uint16, eFormat, const FColorSpace*, const FOnInvalidBlock&, const FOnCleanupData&, const FSchedulePolicy >( &FContext::XAllocateBlockData )
            , "block"_a, "width"_a, "height"_a, "format"_a = eFormat::Format_RGBA8, "colorspace"_a = nullptr, "onInvalid"_a = FOnInvalidBlock(), "onCleanup"_a = FOnCleanupData( &OnCleanup_FreeMemory ), "policy"_a = FSchedulePolicy::MonoChunk, "waitList"_a = py::list(), "event"_a = nullptr )
        .def( "XBuildMipMap", ctxCallAdapter< const FBlock&, FBlock&, int, const FRectI&, eResamplingMethod, const FSchedulePolicy& >( &FContext::XBuildMipMap )
            , "src"_a, "dst"_a, "maxMipLevel"_a = -1, "rect"_a = FRectI::Auto, "resamplingMethod"_a = eResamplingMethod::Resampling_Bilinear, "policy"_a = FSchedulePolicy::MultiScanlines, "waitList"_a = py::list(), "event"_a = nullptr )
        .def( "XCreateTestBlock", ctxCallAdapter< FBlock&, const FSchedulePolicy& >( &FContext::XCreateTestBlock )
            , "block"_a, "policy"_a = FSchedulePolicy::MultiScanlines, "waitList"_a = py::list(), "event"_a = nullptr )
        .def( "XDeallocateBlockData", ctxCallAdapter< FBlock&, const FSchedulePolicy& >( &FContext::XDeallocateBlockData )
            , "block"_a, "policy"_a = FSchedulePolicy::MonoChunk, "waitList"_a = py::list(), "event"_a = nullptr )
        .def( "XLoadBlockFromDisk", ctxCallAdapter< FBlock&, const std::string&, const FSchedulePolicy& >( &FContext::XLoadBlockFromDisk )
            , "block"_a, "path"_a, "policy"_a = FSchedulePolicy::MonoChunk, "waitList"_a = py::list(), "event"_a = nullptr )
        .def( "XProcessBezierDisplacementField", ctxCallAdapter< const FBlock&, const FBlock&, FBlock&, FBlock&, const TArray< FCubicBezierControlPoint >&, float, ULIS::uint32, const FRectI&, eResamplingMethod, eBorderMode, const ISample&, const FSchedulePolicy& >( &FContext::XProcessBezierDisplacementField )
            , "src"_a, "dst"_a, "field"_a, "mask"_a, "points"_a, "threshold"_a = 1.f, "plotSize"_a = 1, "rect"_a = FRectI::Auto, "resamplingMethod"_a = eResamplingMethod::Resampling_Bilinear, "borderMode"_a = eBorderMode::Border_Transparent, "color"_a = FColor::Transparent, "policy"_a = FSchedulePolicy::MonoChunk, "waitList"_a = py::list(), "event"_a = nullptr );
