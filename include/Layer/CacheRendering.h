...
* @brief        This file provides the declaration for the ICachedImageRendering class.
...
/////////////////////////////////////////////////////
/// @class      ICachedImageRendering
/// @brief      The ICachedImageRendering class provides a base abstract interface to
///             perform cached renders of contents for layers
class ULIS_API ICachedImageRendering
{
protected:
